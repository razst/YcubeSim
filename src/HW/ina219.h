...
/* Modified by Raz Steinmets for C (gcc) compiler
 ...
 */
         ...
         */
        //INA219_Init(float shunt_resistance, float max_expected_amps);
        /**
         * @brief If the current draw from the system is known, it will
         *        give better resolution in the measurements.
         ...
         */
        void INA219_Init(float shunt_resistance, float max_expected_amps, uint8_t address); // Custom device address and amps
